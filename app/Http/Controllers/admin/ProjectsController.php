...
class ProjectsController extends Controller
{
    ...
    public function index()
    {
        ...
        $pages = Page::where('status', 1)
            ->where('type', 'project')
            ->get();
        return view('pages.dashboard.projects.index', compact('pages'));
    }

    // Show create form
    public function create()
    {
        $pages = Page::where('type', 'project')->where('status', 1)->get();
        return view('pages.dashboard.projects.create', compact('pages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file_input') && $request->file('file_input')->isValid()) {
            ...
            $filePath = 'assets/uploads/projects/';
        ...
        return redirect()->route('admin.pages')->with('success', 'Project Page created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        $pages = Page::where('type', 'project')->where('status', 1)->get();
        return view('pages.dashboard.projects.edit', compact('page', 'pages'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('file_input')) {
            $filePath = 'public/assets/uploads/projects/';
        ...
        // Redirect or return response
        return redirect()->route('admin.pages')->with('success', 'Project Page updated successfully');
    }
    ...
    public function delete($id)
    {
        ...
        // if ($page->feature_image) {
        //     Storage::delete('public/assets/uploads/projects/' . $page->feature_image);
        // }
        if (!empty($page->feature_image) && Storage::exists('public/assets/uploads/projects/' . $page->feature_image)) {
            Storage::delete('public/assets/uploads/projects/' . $page->feature_image);
        }
        ...
        return redirect()->route('admin.pages')->with('success', 'Project Page status updated to inactive');
