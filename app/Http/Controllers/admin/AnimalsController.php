...
class AnimalsController extends Controller
{
    ...
    public function index()
    {
        ...
        $pages = Page::where('status', 1)
            ->where('type', 'animal')
            ->get();
        return view('pages.dashboard.animals.index', compact('pages'));
    }

    // Show create form
    public function create()
    {
        $pages = Page::where('type', 'animal')->where('status', 1)->get();
        return view('pages.dashboard.animals.create', compact('pages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file_input') && $request->file('file_input')->isValid()) {
            ...
            $filePath = 'assets/uploads/animals/';
        ...
        return redirect()->route('admin.animals')->with('success', 'Animal Page created successfully');
    }
    ...
    public function edit($id)
    {
        ...
        $pages = Page::where('type', 'animal')->where('status', 1)->get();
        return view('pages.dashboard.animals.edit', compact('page', 'pages'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('file_input')) {
            $filePath = 'public/assets/uploads/animals/';
        ...
        // Redirect or return response
        return redirect()->route('admin.animals')->with('success', 'Animal Page updated successfully');
    }
    ...
    public function delete($id)
    {
        ...
        $defaultPages = ['home', 'about-us', 'page', 'gallery', 'music-tracks', 'music-videos', 'home-section-video', 'animal'];

        // Check if the page is a default page
        if (in_array($page->slug, $defaultPages)) {
            return redirect()->route('admin.animals')->with('error', 'You cannot delete the "' . $page->title . '" page as it is a default page.');
        }
        ...
        // }
        if (!empty($page->feature_image) && Storage::exists('public/assets/uploads/animals/' . $page->feature_image)) {
            Storage::delete('public/assets/uploads/animals/' . $page->feature_image);
        }
        ...
        return redirect()->route('admin.animals')->with('success', 'Animal Page status updated to inactive');
