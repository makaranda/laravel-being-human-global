    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block">
                <a href="{{ route('home.index') }}" target="_new" class="nav-link">Home</a>
            </li>
            {{-- <li class="nav-item d-none d-md-block"><a href="{{ route('frontend.about') }}" target="_new"
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="{{ asset('public/assets/images/user_icon.png') }}"
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        <img src="{{ asset('public/assets/images/user_icon.png') }}" class="rounded-circle shadow"
                            alt="User Image" />
                        <p>
                    ...
                    <li class="user-footer">
                        <a href="{{ route('admin.edituser', Auth::user()->id) }}"
...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    <!--begin::Sidebar Brand-->
    <div class="sidebar-brand bg-white shadow-lg">
        <!--begin::Brand Link-->
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li
                    class="nav-item {{ request()->routeIs('admin.mainslider', 'admin.homepage', 'admin.editmainslider', 'admin.settings', 'admin.mainslider', 'admin.createmainslider', 'admin.editmainslider') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.mainslider') }}"
                                class="nav-link {{ request()->routeIs('admin.mainslider', 'admin.editmainslider') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Home Slider</p>
                            </a>
                        </li>
                ...
                <li
                    class="nav-item {{ request()->routeIs('admin.pages', 'admin.createpage', 'admin.editpage') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.createpage') }}"
                                class="nav-link {{ request()->routeIs('admin.createpage') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Add Page</p>
                            </a>
                        </li>
                ...
                <li
                    class="nav-item {{ request()->routeIs('admin.events', 'admin.createevent', 'admin.editevent', 'admin.events.items', 'admin.createevent.items', 'admin.editevent.items') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                        <i class="nav-icon bi bi-pencil-square"></i>
                        <p>
                            Galleries
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.events') }}"
                                class="nav-link {{ request()->routeIs('admin.events', 'admin.createevent', 'admin.editevent') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Gallery List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.events.items') }}"
                                class="nav-link {{ request()->routeIs('admin.events.items', 'admin.createevent.items', 'admin.editevent.items') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Gallery Items</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.products') }}"
                                class="nav-link {{ request()->routeIs('admin.products', 'admin.createproduct', 'admin.editproduct') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Products List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.createproduct') }}"
                                class="nav-link {{ request()->routeIs('admin.createproduct') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Add Products</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.orders') }}"
                                class="nav-link {{ request()->routeIs('admin.orders', 'admin.createproduct', 'admin.editproduct') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Orders List</p>
                            </a>
                        </li>
                ...
                {{--
                <li
                    class="nav-item {{ request()->routeIs('admin.galleryhome', 'admin.editgalleryhome', 'admin.addgalleryhome') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.galleryhome') }}"
                                class="nav-link {{ request()->routeIs('admin.galleryhome') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Galleries List</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.addgalleryhome') }}"
                                class="nav-link {{ request()->routeIs('admin.galleryhome') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Add Gallery</p>
                            </a>
                ...
                <li
                    class="nav-item {{ request()->routeIs('admin.users', 'admin.adduser', 'admin.edituser') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.adduser') }}"
                                class="nav-link {{ request()->routeIs('admin.adduser') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Add User</p>
                            </a>
                        </li>
                ...
                <li
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.homesecaccording') }}"
                                class="nav-link {{ request()->routeIs('admin.homesecaccording','admin.edithomesecaccording','admin.createhomesecaccording') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                ...
                <li
                    class="nav-item {{ request()->routeIs('admin.uploads', 'admin.createupload', 'admin.editupload') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                        <i class="nav-icon bi bi-image"></i>
                        <p>
                            Media
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.createupload') }}"
                                class="nav-link {{ request()->routeIs('admin.users') ? 'active' : '' }}">
                                <i class="nav-icon bi bi-circle"></i>
                                <p>Add File</p>
                            </a>
