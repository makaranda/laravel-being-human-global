...
<link
    href="https://fonts.googleapis.com/css2?family=Playwrite+AU+QLD:wght@100..400&family=Playwrite+IN:wght@100..400&family=Raleway:ital,wght@0,100..900;1,100..900&display=swap"
    rel="stylesheet">
<link
    href="https://fonts.googleapis.com/css2?family=Crimson+Pro:ital,wght@0,200..900;1,200..900&family=Playwrite+AU+QLD:wght@100..400&family=Playwrite+IN:wght@100..400&family=Raleway:ital,wght@0,100..900;1,100..900&display=swap"
    rel="stylesheet">
...
<link rel="stylesheet" href="{{ url('public/assets/frontend/css/owl.css') }}">
<link rel="stylesheet" href="{{ url('public/assets/frontend/css/bootstrap.css') }}">
<link rel="stylesheet" href="{{ url('public/assets/frontend/css/jquery.fancybox.min.css') }}">
<link rel="stylesheet" href="{{ url('public/assets/frontend/css/animate.css') }}">
<link rel="stylesheet" href="{{ url('public/assets/frontend/css/color.css') }}">
