@php
    ...
    if ($page_seo) {
        ...
        if ($current_route_name == 'frontend.home.ourworks.article.view') {
            $seo_keywords = $blog->seo_keywords;
            $seo_description = $blog->seo_description;
        } elseif ($current_route_name == 'frontend.blogs.article.view') {
            $seo_keywords = $blog->seo_keywords;
            $seo_description = $blog->seo_description;
        } else {
...
<head>
    ...
    <title>{{ ($seo_keywords != '') ? $settings['website_name'] . ' | ' . $seo_keywords : $settings['website_title'] }}
    </title>
