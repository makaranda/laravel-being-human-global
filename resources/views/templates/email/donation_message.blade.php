                ...
                <tr>
                  <td bgcolor="#ffffff" align="left"
                    ...
                    <p style="margin:0;color:#161414"><strong
                        style="text-transform:capitalize;font-family:sans-serif">Donated Person Details</strong>
                      <br> Donation Category - {{ $data['category'] }} Contribution
                      @if($data['donation_type'])
                        <br> Donation Type - {{ $data['donation_type'] }}
                      @endif
                      @if($data['amount'])
                        <br> Donation Amount - {{ $data['amount'] }}
                      @endif
                      <br> Address - {{ $data['address'] }}
                      <br> City - {{ $data['city'] }}
                      <br> Province / State - {{ $data['province'] }}
                      <br> Postal Code - {{ $data['billing_info_postal_code'] }}
