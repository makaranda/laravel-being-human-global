...
<head>
  ...
  <title>New Donation Message</title>
</head>
                ...
                <tr>
                  <td bgcolor="#ffffff" align="left"
                    ...
                    <p style="margin:50px 0 50px;color:#161414;font-family:sans-serif;font-size:16px;line-height:28px">
                      ...
                      We are truly grateful for your generous donation to {{ env('APP_NAME') }}.<br><br>
                      Your support helps us continue our mission of protecting wildlife, conserving nature, and creating
                      a better future for generations to come.<br><br>
                      Every contribution — big or small — makes a difference. Thanks to you, we can keep making real
                      change possible.<br><br>
                      Our team will be in touch if we need any further details, but please know that your gift is
                      already at work.
                    </p>
                  </td>
                </tr>
