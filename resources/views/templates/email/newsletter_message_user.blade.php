                                        ...
                                        <a href="#m_6772889176826120015_" style="text-decoration:none">
                                            <span
                                                ...
                                                <img src="{{ asset('public/assets/frontend/img/' . $settings['main_logo']) }}"
                                                    alt="{{ $settings['website_name'] }}" width="400px" class="CToWUd"
                                                    data-bit="iit">
                                            </span>
                                        </a>
                                    </td>
                            ...
                            <tbody>
                                <tr>
                                    <td bgcolor="#ffffff" align="left"
                                        ...
                                        <p
                                            style="margin:50px 0 50px;color:#161414;font-family:sans-serif;font-size:16px;line-height:28px">
                                            Dear
                                            <strong>{{ $data['first_name'] . ' ' . $data['last_name'] }}</strong>,<br><br>
                                            Thank you for subscribing to our newsletter! <br><br>
                                            You've just joined a community committed to making a difference — for
                                            nature, for families, and for future generations.<br><br>
                                            Expect inspiring updates, stories from the wild, and ways you can help bring
                                            positive change to our world. <br><br>
                                            Stay connected, stay informed — and welcome to the journey.
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                <tr style="display:none">
                                    <td bgcolor="#ffffff" align="left"
                                        ...
                                        <p style="margin:0">
                                            <a href="#m_6772889176826120015_"
                                                style="color:#999999;font-weight:700">Music Tracks</a> -
                                            <a href="#m_6772889176826120015_"
                                                style="color:#999999;font-weight:700">About</a> -
                                            <a href="#m_6772889176826120015_"
                                                style="color:#999999;font-weight:700">Contact Us</a>
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" align="left"
                                        ...
                                        <p style="margin:0;color:#b37b16">
                                            Together, we uphold the Word of God with unwavering integrity — inspiring
                                            families who give generously to protect wildlife and preserve creation.
                                        </p>>
                                    </td>
                                </tr>
