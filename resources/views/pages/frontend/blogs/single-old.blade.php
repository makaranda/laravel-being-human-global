            ...
            <div class="col-lg-8 posts-list">
                <div class="single-post">
                    <div class="feature-img">
                        <img src="{{ url('public/assets/uploads/blogs/' . $blog->feature_image) }}" alt="{{ $blog->title }}" class="border shadow-lg img-fluid"/>
                    </div>
                    ...
                    <div class="row">
                            ...
                            @if ($prev_blog)
                                <div class="thumb">
                                    <a href="{{ route('frontend.blogs.article.view', $prev_blog->slug) }}">
                                        <img class="img-fluid" src="{{ $prev_blog->feature_image ? url('public/assets/uploads/blogs/' . $prev_blog->feature_image) : asset('assets/img/post/preview.jpg') }}" alt="{{ $prev_blog->title }}" />
                                    </a>
                                </div>
                                <div class="arrow">
                                    <a href="{{ route('frontend.blogs.article.view', $prev_blog->slug) }}">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                            @if ($next_blog)
                                ...
                                <div class="thumb">
                                    <a href="{{ route('frontend.blogs.article.view', $next_blog->slug) }}">
                                        <img class="img-fluid" src="{{ $next_blog->feature_image ? url('public/assets/uploads/blogs/' . $next_blog->feature_image) : asset('assets/img/post/next.jpg') }}" alt="{{ $next_blog->title }}" />
                                    </a>
                                </div>
                            @endif
                        </div>
                ...
                @if ($blog->author)
                    <div class="blog-author">
                        <div class="media align-items-center">
                            <img src="{{ $blog->author->profile_picture ?? asset('assets/img/blog/author.png') }}" alt="{{ $blog->author->name }}">
                        ...
                        @if (!empty($recent_blogs) && $recent_blogs->count())
                            @foreach ($recent_blogs as $recent_blog)
                                ...
                                <div class="media post_item">
                                    <img
                                        src="{{ $recent_blog->feature_image ? url('public/assets/uploads/blogs/' . $recent_blog->feature_image) : url('public/assets/images/default-blog.jpg') }}"
