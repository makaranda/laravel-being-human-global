                    ...
                    <div class="content_block_three">
                        <div class="content-box">
                            <div class="inner mb-20">
                                ...
                                <h5><strong>Human-Elephant Conflict: The Cost of Coexistence</strong>.</h5>
                            </div>
                            <div class="text mb-20">
                                <p class="mb-20">Human-elephant conflict (HEC) continues to take a heavy toll across Asia
                                    and Africa. The statistics below reflect the scale of this crisis, impacting both people
                                    and elephants, and threatening the fragile balance between conservation and community
                                    safety.</p>
                                <h4><strong>Bridging the Divide: Our New Project to Tackle Human-Elephant Conflict.</strong>
                                </h4>
                                <p class="mb-20">Across Asia and Africa, <strong>Human-Elephant Conflict (HEC)</strong> is
                                    escalating, taking lives, destroying crops, and placing immense pressure on both
                                    communities and conservation efforts. As elephant habitats shrink, the struggle over
                                    space intensifies, threatening a delicate balance between survival and coexistence.</p>
