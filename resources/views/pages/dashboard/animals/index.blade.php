                    ...
                    <div class="col-12 col-md-12">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col text-end">
                                <a href="{{ route('admin.createanimal') }}" id="add_blog" name="add_blog"
                                    class="btn btn-gray border float-right">Add Page</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr class="action_area">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn_action_area">
                                                    <a href="{{ route('admin.editanimal', $page->id) }}" target="_self">Edit</a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.page_trash').on('click', function () {
                ...
                var ajax_url = "{{ route('admin.deleteanimal', ':id') }}";
                ajax_url = ajax_url.replace(':id', page_id);

                // Call the AlertModelDetails function
                AlertModelDetails(
                    'Confirm Deletion',
                    'Are you sure you want to delete this animal page?',
                    'Cancel',
                    'Delete',
                    page_id,
                    ajax_url,
