...
@section('content')
  ...
  <div class="container mt-5">
    <form action="{{ route('admin.storeanimal') }}" id="formSubmit" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
      ...
      @enderror
          ...
          <textarea rows="4" class="form-control mt-3" placeholder="Short Description" name="sub_description"
            id="sub_description">{{ old('sub_description') }}</textarea>
      ...
      <div class="card">
        ...
        <button class="form-control btn btn-primary" type="submit" name="switch_submit"
          id="switch_submit">Publish</button>
        </div>
      </div>
      <div class="card mt-3">
      ...
      @enderror
          ...
          <input type="number" class="form-control mt-3" max="100" min="0" placeholder="Order"
            value="{{ old('order', 0) }}" name="order" id="order">
          @error('order')
        <div class="text-danger">{{ $message }}</div>
      @enderror
          </div>
      ...
      <div class="card mt-3">
        ...
        <div class="row justify-content-center">
          ...
          <button type="button" class="btn btn-link text-danger d-none" name="remove_image"
          ...
          <button type="button" class="btn btn-link" name="feature_image" id="feature_image">Set featured
            image</button>
          @error('feature_image')
        <div class="text-danger">{{ $message }}</div>
      @enderror
