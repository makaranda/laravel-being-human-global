                    ...
                    <div class="col-12 col-md-12">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col text-end">
                                <a href="{{ route('admin.createtestimonial') }}" id="add_blog" name="add_blog"
                                    class="btn btn-gray border float-right">Add Testimonial</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr class="action_area">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn_action_area">
                                                    <a href="{{ route('admin.edittestimonial', $page->id) }}"
                                                        target="_self">Edit</a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.page_trash').on('click', function () {
                ...
                var ajax_url = "{{ route('admin.deletetestimonial', ':id') }}";
