...
@section('content')
    <div class="container mt-5">
        <form action="{{ route('admin.updatepage', $page->id) }}" id="formSubmit" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form-control mt-3" placeholder="Add Title" name="title"
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="Short Description"
                                        name="sub_description"
                                        id="sub_description">{{ old('sub_description', $page->sub_description) }}</textarea>
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="Description"
                                        name="description"
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        @if(isset($page->video))
                                            ...
                                            <video controls class="pt-3" width="100%">
                                                <source src="{{ url('public/assets/uploads/videos/' . $page->video) }}"
                                                    type="video/mp4">
                                                <source src="{{ url('public/assets/uploads/videos/' . $page->video) }}"
                                                    type="video/webm">
                                                Your browser does not support the video element.
                                            </video>
                                            <p class="text-danger"><span class="fw-bold">Existing File Name:</span>
                                                {{ $page->video }}</p>
                                        @endif
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="switch_publish"
                                            id="switch_publish" {{ old('switch_publish', $page->status) ? 'checked' : '' }} />
                                        <label class="form-check-label" for="switch_publish">Default switch to Publish
                                            Page</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <input type="number" class="form-control mt-3" max="100" min="0" placeholder="Order"
                                        value="{{ old('order', $page->order) }}" name="order" id="order">
                                    @error('order')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    @if($page->feature_image)
                                        <img src="{{ asset('public/assets/uploads/pages/' . $page->feature_image) }}"
                                        ...
                                        <button type="button" class="btn btn-link text-danger" name="remove_image"
                                            id="remove_image">Remove featured image</button>
                                    @else
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-12 col-md-12 mt-3">
                                        <!-- Display image if it exists -->
                                        @if($page->video_image)
                                            <img src="{{ asset('public/assets/frontend/img/about/' . $page->video_image) }}"
                                            ...
                                            <button type="button" class="btn btn-link text-danger" name="remove_image2"
                                                id="remove_image2">Remove Video image</button>
                                        @else
                                    ...
                                    <div class="col-12 col-md-12 mt-3">
                                        ...
                                        <button type="button" class="btn btn-link" name="video_image" id="video_image">Set Video
                                            image</button>
                                        @error('video_image')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
