...
@section('content')
    ...
    <div class="container mt-5">
        ...
        @endif
        <form action="{{ route('admin.updatesettings', $setting->id) }}" id="formSubmit" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control mt-3" name="website_name" id="website_name"
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" class="form-control mt-3" name="website_title" id="website_title"
                                        value="{{ old('website_title', $setting->website_title) }}">
                                    @error('website_title')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12 mt-3">
                                    <label class="fw-bold">Contact Number</label>
                                    <input type="text" class="form-control mt-3" name="contact_number" id="contact_number"
                                        value="{{ old('contact_number', $setting->contact_number) }}">
                                    @error('contact_number')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12 mt-3">
                                    <label class="fw-bold">Email Address</label>
                                    <input type="text" class="form-control mt-3" name="email_address" id="email_address"
                                        value="{{ old('email_address', $setting->email_address) }}">
                                    @error('email_address')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12 mt-3">
                                    <label class="fw-bold">Address</label>
                                    <input type="text" class="form-control mt-3" name="address" id="address"
                                        value="{{ old('address', $setting->address) }}">
                                    @error('address')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12 mt-3">
                                    <label class="fw-bold">Google Map Link</label>
                                    <textarea rows="6" class="form-control mt-3" name="google_map"
                                        id="google_map">{{ old('google_map', $setting->google_map) }}</textarea>
                                    @error('google_map')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12 mt-3">
                                    <label class="fw-bold">Footer Content</label>
                                    <textarea rows="5" class="form-control mt-3" name="footer_content"
                                        id="footer_content">{{ old('footer_content', $setting->footer_content) }}</textarea>
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" class="form-control mt-3" name="special_offer" id="special_offer"
                                        value="{{ old('special_offer', $setting->special_offer) }}">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" class="form-control mt-2" name="social_facebook" id="social_facebook"
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" class="form-control mt-2" name="social_linkedin" id="social_linkedin"
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" class="form-control mt-2" name="social_instagram"
                                        id="social_instagram"
                                ...
                                <div class="col-12 mt-3">
                                    ...
                                    <input type="text" class="form-control mt-2" name="social_youtube" id="social_youtube"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="SEO Keywords"
                                        name="seo_keywords"
                                        id="seo_keywords">{{ old('seo_keywords', $setting->seo_keywords) }}</textarea>
                                    @error('seo_keywords')
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="SEO Description"
                                        ...
                                        id="seo_description">{{ old('seo_description', $setting->seo_description) }}</textarea>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <span class="form-check-label ms-2">Active Status</span>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <label class="custom-switch">
                                <input type="checkbox" name="switch_slider" id="switch_slider" {{ $setting->switch_slider ? 'checked' : '' }}>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    @if($setting->main_logo)
                                        <img src="{{ asset('public/assets/frontend/img/' . $setting->main_logo) }}"
                                        ...
                                        <button type="button" class="btn btn-link text-danger" name="remove_image"
                                            id="remove_image">Remove Main Logo</button>
                                    @else
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    @if($setting->footer_logo)
                                        <img src="{{ asset('public/assets/frontend/img/' . $setting->footer_logo) }}"
                                            class="img-fluid" id="image_show4" />
                                        <p class="btn mb-0" id="img_description4">Click the image to edit or update</p>
                                        <button type="button" class="btn btn-link text-danger" name="remove_image4"
                                            id="remove_image4">Remove Footer Logo</button>
                                    @else
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <button type="button" class="btn btn-link" name="footer_image" id="footer_image">Set
                                        Footer Logo</button>
                                    @error('footer_image')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    @if($setting->fevicon_logo)
                                        <img src="{{ asset('public/assets/frontend/img/' . $setting->fevicon_logo) }}"
                                            class="img-fluid" id="image_show2" />
                                        <p class="btn mb-0" id="img_description2">Click the image to edit or update</p>
                                        <button type="button" class="btn btn-link text-danger" name="remove_image2"
                                            id="remove_image2">Remove Fevicon Logo</button>
                                    @else
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <button type="button" class="btn btn-link" name="fevicon_image" id="fevicon_image">Set
                                        Fevicon Logo</button>
                                    @error('fevicon_logo')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    @if($setting->page_banner)
                                        <img src="{{ asset('public/assets/frontend/img/banner/' . $setting->page_banner) }}"
                                        ...
                                        <button type="button" class="btn btn-link text-danger" name="remove_image3"
                                            id="remove_image3">Remove Page Banner</button>
                                    @else
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <button type="button" class="btn btn-link" name="page_banner_image"
                                        id="page_banner_image">Set Page Banner</button>
