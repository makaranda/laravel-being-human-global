                ...
                <table id="pages_list" class="table table-striped table-bordered" style="width:100%">
                    <thead>
                        <tr class="action_area">
                            ...
                            <th class="tbl_col3">Email</th>
                            <th class="tbl_col3">Phone</th>
                            <th class="tbl_col3">Country</th>
                            <th class="tbl_col3">Address</th>
                            ...
                            @foreach ($users as $user)
                                <tr class="action_area">
                                    ...
                                    <td>
                                        ...
                                        <div class="date_time">
                                            {{ \Carbon\Carbon::parse($user->updated_at)->format('Y/m/d \a\t g:i a') }}
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
...
@push('scripts')
    <script>
        ...
        $('.page_trash').on('click', function () {
            ...
            var ajax_url = "{{ route('admin.deletedonator', ':id') }}";
