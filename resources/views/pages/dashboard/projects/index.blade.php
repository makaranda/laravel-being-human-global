...
@section('content')
    ...
    <div class="container mt-5">
        ...
        @endif
        <div class="card">
            <div class="card-header">Projects Content</div>
            <div class="card-body">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col text-end">
                                <a href="{{ route('admin.createproject') }}" id="add_blog" name="add_blog"
                                    class="btn btn-gray border float-right">Add Project Page</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr class="action_area">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn_action_area">
                                                    <a href="{{ route('admin.editproject', $page->id) }}" target="_self">Edit</a>
                                            ...
                                            <td>
                                                ...
                                                <div class="date_time">
                                                    {{ \Carbon\Carbon::parse($page->updated_at)->format('Y/m/d \a\t g:i a') }}
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.page_trash').on('click', function () {
                ...
                var ajax_url = "{{ route('admin.deleteproject', ':id') }}";
                ajax_url = ajax_url.replace(':id', page_id);

                // Call the AlertModelDetails function
                AlertModelDetails(
                    'Confirm Deletion',
                    'Are you sure you want to delete this project page?',
                    'Cancel',
                    'Delete',
                    page_id,
                    ajax_url,
