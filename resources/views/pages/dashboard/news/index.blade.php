...
@section('content')
    ...
    <div class="container mt-5">
        ...
        @endif
        <div class="card">
            <div class="card-header">News Content</div>
            <div class="card-body">
                    ...
                    <div class="col-12 col-md-12">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col text-end">
                                <a href="{{ route('admin.createnews') }}" id="add_blog" name="add_blog"
                                    class="btn btn-gray border float-right">Add News</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr class="action_area">
                                            ...
                                            <td>
                                                ...
                                                <div class="btn_action_area">
                                                    <a href="{{ route('admin.editnews', $blog->id) }}" target="_self">Edit</a>
                                            ...
                                            <td>
                                                ...
                                                <div class="date_time">
                                                    {{ \Carbon\Carbon::parse($blog->updated_at)->format('Y/m/d \a\t g:i a') }}
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.page_trash').on('click', function () {
                ...
                var ajax_url = "{{ route('admin.deletenews', ':id') }}";
                ajax_url = ajax_url.replace(':id', page_id);

                // Call the AlertModelDetails function
                AlertModelDetails(
                    'Confirm Deletion',
                    'Are you sure you want to delete this News Blog Item..??',
                    'Cancel',
                    'Delete',
                    page_id,
                    ajax_url,
