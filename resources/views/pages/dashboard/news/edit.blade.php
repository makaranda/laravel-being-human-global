...
@section('content')
    <div class="container mt-5">
        <form action="{{ route('admin.updateblog', $blog->id) }}" id="formSubmit" method="POST"
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="Short Description"
                                        ...
                                        id="sub_description">{{ old('sub_description', $blog->sub_description) }}</textarea>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="SEO Keywords"
                                        name="seo_keywords"
                                        id="seo_keywords">{{ old('seo_keywords', $blog->seo_keywords) }}</textarea>
                                    @error('seo_keywords')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <textarea rows="4" class="form-control mt-3" placeholder="SEO Description"
                                        ...
                                        id="seo_description">{{ old('seo_description', $blog->seo_description) }}</textarea>
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="switch_publish"
                                            id="switch_publish" {{ old('switch_publish', $blog->status) ? 'checked' : '' }} />
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    <input type="number" class="form-control mt-3" max="100" min="0" placeholder="Order"
                                        value="{{ old('order', $blog->order) }}" name="order" id="order">
                                    @error('order')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12 mt-3">
                                    ...
                                    @if($blog->feature_image)
                                        <img src="{{ asset('public/assets/uploads/blogs/' . $blog->feature_image) }}"
                            ...
                            <div class="card-body">
                                <div class="row justify-content-center">
                                    <div class="col-12 col-md-12 mt-3">
                                        <!-- Display image if it exists -->
                                        @if($blog->video_image)
                                            <img src="{{ asset('public/assets/frontend/img/about/' . $blog->video_image) }}"
