                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12">
                                    ...
                                    <input type="text" class="form-control mt-3" placeholder="Top Text" name="top_text"
                                        id="top_text" value="{{ old('top_text') }}">
                                    @error('top_text')
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-footer">
                            <button class="form-control btn btn-primary" type="submit">Publish</button>
                        </div>
                    </div>
                    ...
                    {{-- <div class="card">
                        ...
                        <div class="card-body">
                            <label class="custom-switch">
                                <input type="checkbox" name="switch_slider" id="switch_slider" checked>
